...
module.exports = {
  showDiagramsList: function(req, res){
  ...
  addNewDiagram: function(req, res){
  ...
  getDiagramImage: function(req,res){
  ...
  removeDiagram: function(req, res){
  ...
  updateDiagram: function(req, res){
